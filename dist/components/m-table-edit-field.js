...
function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableEditField, [{
    ...
    key: "coerceLookupType",
    value: function coerceLookupType(type, value) {
      if (type === 'numeric') {
    ...
    value: function renderLookupField() {
      ...
      return React.createElement(_Select["default"], (0, _extends2["default"])({}, this.getProps(), {
        ...
        onChange: function onChange(event) {
          ...
          if (_this.props.columnDef.type !== undefined) {
            value = _this.coerceLookupType(_this.props.columnDef.type, event.target.value);
          }
